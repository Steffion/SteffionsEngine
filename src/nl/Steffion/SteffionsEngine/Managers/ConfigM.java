...
import nl.Steffion.SteffionsEngine.W;
...
public class ConfigM {
	...
	public ConfigM (String fileName) {
		...
		this.file = new File("plugins/" + SteffionsEngine.pdfFile.getName(),
				fileName + ".yml");
		this.fileLocation = SteffionsEngine.pdfFile.getName();
	...
	public void checkFile() {
		if (!this.file.exists()) {
			try {
				...
				if (this.fileLocation == SteffionsEngine.pdfFile.getName()) {
